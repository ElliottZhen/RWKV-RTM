...
def transform_trackingnet(tracker_name, cfg_name):
    ...
    src_dir = os.path.join(result_dir, "%s/%s/trackingnet/fermt/trackingnet/" % (tracker_name, cfg_name))
    dest_dir = os.path.join(result_dir, "%s/%s/trackingnet/fermt/trackingnet_submit/" % (tracker_name, cfg_name))
