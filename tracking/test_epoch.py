...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--save_name', type=str, default='fermt-' + str(num), help='Name of save file.')
...
if __name__ == '__main__':
    cfg = 'vit_tiny_ep300'
    # datasets = ['lasot', 'vasttrack', 'trackingnet', 'lasot_extension_subset', 'tnl2k', 'uav']  # 'got10k_test'
    datasets = ['vasttrack']  # 'got10k'
    epochs = [300]
    for num in epochs:
        epoch = num
        savename = 'fermt_ep' + str(epoch)
        for dataset in datasets:
            main(epoch, dataset, cfg, savename)  # test the 300th epoch